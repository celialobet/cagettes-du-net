...
basket_2 = Basket.create(title: "Petite cagette de fruits", description: "Voici un petit panier pour 1 à 2 fruits-addict. Idéal pour compléter vos achats de la semaine et déguster de bons fruits de saison !", price: 9.99, stripe_price: "price_1J541KGYs66l4gchfXhWhnAW")
...
basket_4 = Basket.create(title: "Cagette moyenne de fruits", description: "5kg de fruits pour une petite famille (ou rien que pour vous!), pour mettre du soleil dans votre verre en hiver et faire de belles tartes aux fraises en été!", price: 14.99, stripe_price: "price_1J542kGYs66l4gchMonfwfd7")
